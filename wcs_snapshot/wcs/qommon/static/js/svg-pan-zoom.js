...
, _createZoomIn: function(instance) {
    ...
    zoomIn.setAttribute('transform', 'translate(70 40) scale(0.015)');
...
, _createZoomOut: function(instance){
    ...
    zoomOut.setAttribute('transform', 'translate(70 70) scale(0.015)');
...
SvgPanZoom.prototype.handleMouseWheel = function(evt) {
  var parent_div = evt.target.closest('.svg-pan-zoom-with-ctrl')
  if (!evt.metaKey && !evt.ctrlKey) {
    if (parent_div) {
      clearTimeout(parent_div.scroll_warning_timeout_id)
      if (navigator.platform.toUpperCase().indexOf("MAC") >= 0) {
        parent_div.dataset.handlingScrollWarningText = parent_div.dataset.handlingScrollMacWarningText
      }
      parent_div.classList.add('svg-pan-zoom-handling-scroll-warning')
      parent_div.scroll_warning_timeout_id = setTimeout(function() {
        parent_div.classList.remove('svg-pan-zoom-handling-scroll-warning')
      }, 1000);
      return;
    }
  }
