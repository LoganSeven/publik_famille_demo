...
"""
Django settings for the Publik Famille Demo project.

This file contains default project configuration including
installed apps, middleware, database setup, static/media
files, authentication, and project-specific parameters.

Sensitive values (e.g., secret keys, tokens) are read from
...
MIDDLEWARE = [
    ...
    # The identity verification middleware is injected dynamically by AccountsConfig.ready()
]
...
# ---------------------------------------------------------------------------
# Email backend (console for demo purposes)
# ---------------------------------------------------------------------------
